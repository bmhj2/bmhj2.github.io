...
It also referred to [my recent work](/publications/westburyVoiceRepresentationRelationships2022.qmd) with an interdisciplinary working group in Cambridge. We tried to develop a way of talking and thinking about 'openness' and qualitative methods, but without using terms derived from quantitative social sciences and the STEMM disciplines.^[For example, those posited by [the FAIR framework](https://doi.org/10.1038/sdata.2016.18) on data curation.] This was because we thought those frameworks often misdescribe qualitative data, obscuring both the arguments in favour of making qualitative research more open, and the difficulties involved.
...
My argument in the paper was that these issues---transparency and quality---appear to be more fundamental than the question of whether open data publication *per se* should become the norm for qualitative researchers. There are ways that qualitative researchers could make it easier for others to evaluate their knowledge claims, not all of which necessarily require the publication of sensitive datasets. I may try to develop these ideas further with some colleagues, so I'd welcome feedback on this working paper.

Slides and full text are available on this site:

- [Paper text](/publications/jarmanWhoseDataAnyway2025.qmd)
- [Slides](/publications/jarmanWhoseDataAnyway2025Slides.qmd)
