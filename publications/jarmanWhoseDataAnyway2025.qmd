...
::: {.callout-note}
Slides for this talk are available [here](/publications/jarmanWhoseDataAnyway2025Slides.qmd).
:::
...
But researchers have often noted that complex and contested organisational cultures influence prison life, to a far greater degree than the rules. Your relationships with prison officers and prisoners are crucial in conducting the research. Those relationships can be tricky, and sometimes ethically complicated. There are intense and murky subcultures among both staff and prisoners, which impose demands on them not always foreseen in rules and policies. Consent is negotiated; trust is contingent and often temporary; motivations aren’t always clear; strong social undercurrents affect who talks to you and what they're prepared to say.
...
All that is left is to offer a few key messages, in closing.

First, the underlying shifts driving the open data agenda is already underway. Data is normally digital first, and the idea that there is some relationship between transparency and quality isn't going away.

Second, then, our task is to engage constructively—which might still include declining to publish data.
...
[^2]: Other acronyms are available: one that describes humanities data [CORE—Collected, Organised, Recontextualised and Explained, see @gilbyOpenResearchArts] and one relating to indigenous knowledge [CARE—Collective benefit, Authority to control, Responsibility and Ethics, see @carrollCAREPrinciplesIndigenous2020].