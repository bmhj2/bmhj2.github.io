...
keywords:  
  ...
  - performativity
lang: en-GB
url: https://eprints.soton.ac.uk/id/eprint/504230
...
citation:
  id: jarmanBeingAssessedBeing2025
  abstract: >-
    This paper draws on qualitative data from interviews with men serving life
    sentences for murder to explore their experiences of parole decision-making
    processes. Whilst research on parole decisions has historically focused on
    ...
    investigation into how prisoners perceive and navigate the broader
    administrative processes that shape parole outcomes. Drawing on an
    understanding of parole as a 'social process'
    (Tata, 2020) rather than a singular decision point,
    the paper will consider how prisoners interpret and respond to the
    compilation of their parole dossiers, their perceptions of risk assessment
    procedures, and the ways in which their lived experiences are translated by
    the parole dossier to become evidence of manageable or unmanageable risk,
    for consideration by the Parole Board. Through this consideration, the paper
    will reflect on questions regarding power, legitimacy and agency at the
    intersection of punishment and risk management.
  author:
    - family: Jarman
      given: Ben
  event-place: University of Portsmouth
  event-title: British Society of Criminology Conference 2025
  genre: Conference paper
  issued: 2025-07-03
  language: en-GB
  license: © Ben Jarman 2025, CC BY 4.0
  publisher-place: University of Portsmouth
  title: >-
    Being assessed, being processed: Life-sentenced prisoners’ experiences of
    parole decision-making
  title-short: Being assessed, being processed
  type: speech
  URL: https://benjarman.uk/publications/jarmanBeingAssessedBeing2025.html
---
