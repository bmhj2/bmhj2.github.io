...
lang: en-GB
# doi: 
url: https://eprints.soton.ac.uk/id/eprint/507475
license: CC BY 4.0
# copyright:
#   holder: © The Authors
#   year: 2026
...
Our starting point is the empirical reality of life sentences as experienced by those serving them. Drawing on extensive qualitative research, we show -- initially through non-normative description -- the acute suffering of long-term imprisonment and the complex processes of moral reflection that follow. These diverge markedly from sentencing policy's intended outcomes. We then make the case that life sentences, while effective in causing suffering, often do so excessively, failing to facilitate coherent moral communication or foster reflection on wrongdoing. Intense anguish inhibits constructive moral engagement. By evidencing this, we aim to enrich the dialogue between penal theory and empirical penology.

## Context

As of September 2025, 7,547 men and women were serving life sentences in custody in England & Wales [@ministryofjusticeOffenderManagementStatistics2025a]. This is double the 1993 figure and almost 2,000 more than 20 years ago, meaning life-sentenced prisoners (LSPs) constitute over eight per cent of the prison population. The number serving very long sentences [ie with tariffs over 20 years -- see @ministryofjusticeOffenderManagementStatistics2025, tbl. 1.Q.16] has grown significantly, as has the average tariff for mandatory life sentences [12.5 years in 2003, rising to around 21 years since 2016 -- see @ministryofjusticeFOIRequestISAS2014], and time actually served beyond the tariff point [@ministryofjusticeOffenderManagementStatistics2025, tbl. 1.Q.14].

Changes in murder sentencing stem from legislation, not shifts in the nature or prevalence of homicide [@officefornationalstatisticsHomicideEnglandWales2025]. Introducing the current statutory sentencing regime in 2003, Home Secretary David Blunkett rejected releasing those convicted of 'bestial murders', even with 'sustained evidence of repentance and rehabilitation'. Unambiguous censure was his theme: the law would 'send signals to perpetrators and the wider community' and deter by 'showing [offenders] there will be clear consequences'. Blunkett also cited high-profile examples of serious reoffending to suggest that longer minimum terms would benefit public protection.[^1] Thus, political justifications for increasing murder penalties emphasised censure in the public name and interest; but offered few pointers on what censuring offenders might achieve, what censure might mean to them, or what response might bring about its remission.

Increasingly severe sentences create manifold problems: they prompt feelings of illegitimacy, heighten the appeal of radical ideologies, and further strain an over-stretched prison system [@lieblingExplorationStaffPrisoner2011; @creweLifeImprisonmentYoung2020; @woolfSentencingInflationJudicial2024]. Here, though, we focus on the *intrinsic* consequences of severity, suggesting that unduly severe punishments create suffering and crises of meaning which impede reflection on wrongdoing, and lessen the possibility of rehabilitation.

Our empirical data come from two related projects on people serving life sentences for murder in England & Wales. The first involved men and women with tariffs of 15+ years, sentenced from an early age [for details, see @creweLifeImprisonmentYoung2020]. Surveys were administered to 303 individuals sampled by sentence stage, 146 of whom also engaged in in-depth interviews. The second involved 48 life-sentenced men in one long-term closed and one open prison [for details, see @jarmanMoralMessagesEthical2024], selected for diversity in age at conviction (from teenaged to septuagenarian) and in the severity of the tariff.

## Life Imprisonment and Suffering

Evidence shows that prisoner distress is most common -- and most predictable -- during the period immediately following admission to prison [eg @lieblingPrisonSuicidePrisoner1999]. Survey data and prisoners' accounts corroborate this finding [@hulleyReexaminingProblemsLongterm2016], but the disorientation and 'entry shock' of a very long sentence differ in kind, and not simply in degree, from those associated with imprisonment more generally [@wrightSuppressionDenialSublimation2017]. Most LSPs describe the early sentence phase[^2] as a period of acute anguish, when they are flooded with negative sentiments and an overwhelming hopelessness and despair.

For those in this situation, the present feels meaningless and the future impossible to contemplate:

  > It felt like somebody was ripping my chest open. I saw no future, no point to tomorrow. It was the darkest time of my life. (Maria, 20s, mid)[^3]
...
Many whose tariffs exceed their age at conviction struggle to comprehend what lies ahead:
...
Many LSPs know that contemplating the time which must elapse before release from prison becomes possible will damage their psychological wellbeing. The metaphors used to describe this period are telling, referencing sinking and drowning, or death and decay -- 'dead time' (Jared, 20s, early), 'a waste of life' (Aaron, 40s, late), 'like you're wasting away … you're not living, really … You're just existing' (Sean, 20s, early).
...
Prisoners consistently report lacking institutional support to mitigate the sentence's profound shock. Later, they acknowledge their mental state would have made engaging with such support -- let alone meaningfully reflecting on what they had done -- nearly impossible. Summing up, any early experiences of imprisonment bring crisis and distress; but the early stages of long, indeterminate sentences create distinctive distress that inhibits moral reflection.

In what follows, we highlight the ruptures life imprisonment engenders to illustrate its suffering and show how prisoners' coping styles suppress or leave moral reflection unformed.
...
Before we move on, three points are worth emphasising. First, what we have described is not merely the 'unpleasantness' [@clarkeMoralResponsibilityGuilt2016] or 'burdensomeness' [@duffPunishmentCommunicationCommunity2001] some retributive theorists see as inherent to punishment. Nor is it consistent with experiences at the milder end of  Zaibert's [-@zaibertRethinkingPunishment2018] broadly-drawn concept of 'suffering', a label which eschews euphemism, and highlights the responsibilities punishers incur when they inflict it. Penal suffering thus defined might encompass experiences that are milder (such as sorrow) or harsher (such as psychological disintegration); their effects will influence their justifiability. At the very least, imposing what we have described -- suffering which is acute, harmful, and prolonged, and which appears to numb moral reflection, kill hope, and dehumanise its targets -- would require strong justification.

Second, what contributes most to these feelings is not direct institutional treatment, but existential factors, or relationships and events outside the prison. Indeed, the five problems rated in the survey as most severe were 'Missing somebody', 'Worrying about people outside', 'Feeling that you are losing the best years or your life', 'Having to follow other people's rules and orders' and 'Feeling that your life is being wasted'.[^6] This suggests that, regardless of how decent any institution might be, life imprisonment will generate suffering that is profound, hard to mitigate, and difficult to justify.

Third, there seems to be an inverse relationship between levels of suffering and the potential for constructive moral reflection. Intense distress colonises mental headspace to a degree that precludes productive moral agency. Perhaps ironically, in time, the same ruptures that initially generate trauma open up space for (or spur more directly) more fruitful moral deliberation, through a complicated interaction between sorrow and interruption which reframes suffering as *not meaningless*. It works by separating people from their pre-carceral lifestyles, placing them in circumstances that produce existential clarity about what matters[@lieblingWhatPhilosophyPrison2021], and giving them a surfeit of time to reflect on these losses and aspirations.

## Moral Communication and Reflection in Practice

We now describe the forms of moral reflection evident in our samples, and how institutional discourse activates, transforms or misapprehends them. Empirically, we suggest that they diverge markedly from what retributive theorists might anticipate. To understand this, we need first to explore how such theorists envisage moral communication.
...
Both theorists assume punishment can facilitate an acknowledgement of wrongdoing, an acceptance of responsibility, and a renewed commitment to shared values. They presuppose that 'hard treatment' makes censure difficult to ignore, that calibrated suffering communicates effectively, that offenders will receive the intended moral messages, and that they recognise their punisher's legitimate authority. Critics [eg @golashCasePunishmentRetribution2005, ch 6] have challenged these assumptions. Nevertheless, communicative frameworks offer greater clarity than 'pure' desert theories on retributive punishment's *prospective* aims: meaningful dialogue, respect for moral agency, acknowledgement of wrongdoing, and a potential end to punishment for those who respond appropriately.

A different picture emerges when we examine how moral communication actually unfolds among long-term prisoners. Rather than facilitating moral reflection, we argue that the centrality of risk assessment and management to how the sentence is administered imposes a distorting lens, which often obscures, sometimes occludes, and at best fails to attend to the genuine moral engagement communication theorists seek to promote.

### Risk Discourse and Moral Communication

Because prisons are closed institutions, the moral dialogue of censure is 'oblique' [@garlandPunishmentModernSociety1990, p 186]: implicit and mediated through institutional practices, rather than declared directly in public (as by a court). For LSPs, risk assessment and management are the most important such practices -- and deliver powerful if indirect messages about desirable moral selfhood because they govern progression and release. Risk is *the* dominant rationality directing how the sentence is managed; it dominates policy and public discourse concerning how prisoners may be treated, and dictates the terms on which they might be rehabilitated.

This section unpacks how risk thinking affects censure. Following Williams [-@williamsMoralityPeculiarInstitution2011], we describe an 'actuarial morality system': a framework that transforms ethical considerations into risk factors and subordinates moral dialogue (and deliberation) to risk management. While unambiguously aimed at public protection and not censure, this focus on future risk can distort recognition of past wrongs. By thwarting moral dialogue, it arguably also makes the censure envisaged by communicative theorists impossible.
...
The distortion has several facets. First, attempts to alter future behaviour can indirectly censure past behaviour. Risk assessments draw heavily on interpretations of the past. Similarly, psychological interventions (such as offending behaviour courses) act on future risk partly by labelling past conduct, with the tacit expectation that prisoners learn to apply these labels to themselves. The aim is prospective: to classify attitudes and thereby change them. But it can also intensify censure by imposing a different view of the past, as Rafiq (30s, early) articulated:
  ...
  > The prison courses [are] more focused on your victims, more focused on your danger to society … That's probably why I liked the Sycamore Tree[^7] a fair bit more … It's not about demonising you, it's not all about breaking you down. It's about you acknowledging what you've done, but also that you can give so much back.

The contrast here is between two styles of engagement. In the more dialogical Sycamore Tree course, Rafiq felt recognised as a moral agent whose offence occurred *within a specific relational setting* (in his case, a dysfunctional and emotionally volatile marriage). Seeking moral restoration might include 'acknowledging what you've done' and seeking to 'give something back'. By contrast, Rafiq felt that prison courses classified him as a *general* 'danger to society' -- a 'thin', reductionist characterisation, and one lacking the specific context necessary for a 'thick' description of his personhood. The basis for restoration was not dialogue, reflection, and amends, but learned acquiescence to the prison's framing of his selfhood.

Our contention is that prison risk practices can *stigmatise* without necessarily *censuring*: they detach the offence from its specific relational contexts, replace these with a generic presumption of risk, and label the prisoner as 'risky', with consequences for their future social existence. Rather than engaging prisoners as moral subjects, risk practices treat them as dangerous objects whose autonomy must be constrained. As Timothy (20s, very early) put it: 'when staff look at me, they only look at me from the end of a cattle prod'.

A second distortion arises from how risk assessment, though prospective, demands retrospective narrative performance. To demonstrate reduced future risk, prisoners must somehow signal 'insight' into their past behaviour. Yet what constitutes insight is opaque and shifting, seeming to depend on individual assessors, institutional cultures, and the quality of relationships. The resulting uncertainty is most acute for those maintaining innocence. Unable to admit the index offence, yet wishing to demonstrate some form of accountability, they face a balancing act and sometimes hope that strategic partial admissions -- acknowledging peripheral but not core wrongs -- will suffice: '[I'm innocent of murder, but] I've said I'm not proud of the way I was … in relation to the affairs. I can openly admit [that], I said, 'No-one deserves that' (Ian, 50s, post-tariff).

Ian's carefully calibrated statement exemplifies the 'narrative labour' [@warrAlwaysGottaBe2020] performed by LSPs, crafting accounts that might satisfy perceived demands for 'insight' while preserving a personal understanding of past events. Rather than fostering genuine moral dialogue, this is a fraught performance, where prisoners guess at what the system wants to hear.
...
Amidst resourcing pressures, accessing risk-focused interventions can be difficult, and the intensity and timing of official communication becomes highly contingent. Generally, prisoners with earlier release dates take priority (meaning LSPs whose release is distant do not). However, those assessed as high-risk *in custody* or whose behaviour (eg self-harm, segregation status, prison violence, substance misuse) causes immediate concern may receive intensified or expedited intervention.[^8]

Though a rational allocation of scarce resources, this ensures that the timing and intensity of moral communication varies considerably, influenced by a range of prospective factors unrelated to the retrospective determinants of 'seriousness' used by courts to determine culpability and allocate a commensurate sentence. The timing (or absence) of intervention has unforeseen effects on the censure delivered. During the early sentence stages Tony (30s, mid) experienced the nihilistic anger and overwhelm we note above, particularly relating to shame about his offence. His violence towards prison staff expedited his access to intervention, yielding unexpected benefits:
...
However, many others access interventions only near tariff expiry, if at all; low-risk prisoners may receive none. Systemic inattentiveness, again, seems to signal an indifference to personal development. In such circumstances, 'accountability' implies little more than compliance:
...
These examples demonstrate not only that censure can be distorted by risk, but also that prisons may fail to engage in it at all. Attempts to systematise the management of risk may obstruct or even preclude dialogue, even where prisoners are attempting to engage in it:

  > There's a lad on my spur, I think he's about 20 months into a 22-year tariff. He's asked them … he's asked for TSP,[^9] to get on it, and they're saying, well, you know what, we'll put you on the waiting list, but … there'll be people … that'll need it before you. So … he wrote to Grendon,[^10] and they wrote back [and said] you need to do half your sentence and then reapply. And he's like, woah, that's eleven years! (Liam, 40s, mid)

Our suggestion is that interventions can fail to align with windows of moral openness. As we saw above, distress experienced in the early sentence stage can obstruct meaningful reflection. Some high-risk prisoners encounter intensive intervention at this stage, with potentially positive results. Conversely, others receive attention much later -- when the offence's immediacy has faded -- and show considerable defensiveness and disengagement:
...
Windows for moral dialogue can also close. Often, LSPs reflect that beyond a certain point, continued imprisonment becomes counter-productive, pushing them into a hopelessness which suppresses productive reflection:
...
Prisons standardise moral communication through programmatic interventions. Prisoners' reflections, by contrast, follow individual pathways, require individual catalysts, and tend to explore both culpability and redemption. Often, such reflections occur beyond the scope or the prompting of institutional risk frameworks, taking hold through varied channels. Here, we discuss four significant examples: experiences of grief and loss, informal relationships, commitments to faith and education, and private practices of penance.

Many LSPs reflect on loss -- through bereavement or the ruptures we describe above -- as a kind of solvent for trivial concerns. It clarifies what truly matters, and produces a desire to take responsibility for change. Tom (50s, post-tariff) argued that the efficaciousness of offending behaviour courses *depended on* an earlier experience of bereavement in prison:

  > It made me concentrate on what happened and how I felt when my mum died, so I could understand how they felt when I took their daughter or niece away … *You do not understand loss until you have experienced it* … It made my sentence seem more real, in a way … I was not under any illusion that I was in jail just for nicking a pint of milk … But that is what made me think about it more. Whereas before I was, 'I am a lifer, I am in jail, so what? Let's just get on with it'. I was concentrating on getting my little goals. Now I was concentrating on [my victim and her family] … It made me realise that … I have not really gone into it, and I need to go into it. (emphasis added)

In this example, Tom was reflecting on being unable to comfort grieving family members. Such a personal rupture deepened his moral understanding of loss. However, he also noted that the challenges of *getting through the sentence* ('my little goals') had diverted his attention from the offence. The demands of accountability and the pragmatics of survival were in conflict, something particularly likely to occur in prisons marked by pervasive violence and tension. In such environments -- young offender, high-security, or 'failed-state' [@lieblingAppreciativeInquiryGenerative2015] institutions, for example -- the possibilities for moral engagement are constrained, because daily survival demands emotional suppression, and candour about offences can be risky.

Ethical shifts in prison, then, seem highly personal. For Tom, bereavement was the catalyst. Leon's (40s, mid) priorities shifted after he reflected on his family's loyalty, against the disappearance of his friendships with former associates : 'The most meaningful thing in my life right now? I'd say family. My mum, my brother, my nan … My priorities wasn't in the right place … That's changed now.'

Supportive, trusting friendships within prison could play a similar role. Tony (quoted above) described how supportive words from a prison officer opened a new, less defensive standpoint on his punishment. For some, similar shifts followed comments from trusted peers -- not always positive -- about the offence itself:
...
What enabled Frank to move beyond both defensive indifference and paralysis was not risk-focused programmes, but a chaplain's pastoral recognition of his humanity and potential. Frank heard a perspective which neither ignored his grave wrongdoing nor trapped him in guilt, but instead held out the possibility of moral restoration. Others, too, described how faith practices acknowledged, yet paradoxically also relieved, guilt:

  > I believe that everything that I've done is forgiven because I'm in Christ. I think it's Romans 8 verse 1, 'there is now no condemnation for those in Christ Jesus' … *It's let me go away from my past more*. (Andy, 30s, late; emphasis added)

A final channel for reflection was private practices relating to feelings of guilt. Some participants, particularly those who had killed loved ones, engaged in unrecognised forms of self-punishment. Grant (50s, late) believed the state could never punish him more than he punished himself ('I'll never forgive myself. I don't want to forgive myself') and deliberately stopped taking medication to induce illness. Tom (50s, post-tariff) practised similar self-denial: 'I don't want to feel too good. [My victim] cannot laugh, she cannot smile, she cannot see her family, so why should I? So, if I [feel too good] I would punish myself.' Tom's  methods ranged from self-harm (in earlier years) to self-denial, as when he refused entertainment or moments of conviviality: 'If the lads were having a food boat[^11] … I would say no, bang up, go without, just to punish myself.'

The voluntary nature of these practices distinguishes them, as does their connection to meaningful relationships, including with the memory of victims. Unlike institutional programmes, they emerge from prisoners' inner lives. They acknowledge wrongdoing without seeking institutional validation. Their prevalence remains unclear to us, and probably to prisons themselves. Ironically, then, a system ostensibly promoting accountability shows little interest in prisoners' capacity for it; and much meaningful reflection occurs beyond institutional view.

The existence of these alternative pathways raises uncomfortable questions about how the legitimate normative goals of public protection and rehabilitation might be distorting retributive communication. As Golash [-@golashCasePunishmentRetribution2005] notes in her critique of retributive thinking, the state's relationship with offenders typically lacks the emotional depth which might support moral education. Our participants' accounts lend empirical weight to this theoretical concern. When Ebo (20s, mid; quoted above) spoke of inexperienced staff who assessed risk but 'don't know you or what you've been through', he added: 'You need someone that knows you and has that sort of faith in you'. He suggested that meaningful moral communication requires relational foundations that prisons too often fail to provide. Risk assessments conducted by strangers, however predictively valid, procedurally fair, or professionally competent, might lack the standing to elicit genuine moral engagement.

Exceptions to these patterns are usually found among participants who have served time in institutions which provide a foundation of dignity, alongside a deep commitment to both moral accountability and personal growth. Specifically, prisoners who have been through prison-based therapeutic communities often attest to how these environments treat them as moral agents rather than dangerous objects [@lieblingDescriptionEdgeIIt2015], grant opportunities for development via education and the arts, and look to reconstruct (not colonise) their ethical selfhood [@stevensOffenderRehabilitationTherapeutic2013]. Such contexts offer resources to plot a route away from emotional sedation, defensiveness, and the 'monistic' [@zaibertRethinkingPunishment2018] treatment of risk which typifies contemporary prisons in England & Wales.

## Conclusion

It might be necessary or inevitable that punishment causes suffering. Our argument starts from the idea that retributive suffering reaffirms [or 'vindicates', see @hamptonCorrectingHarmsRighting1991; @norrieRethinkingCriminalJustice2026] values violated by wrongdoing. If it does, then the values affirmed, and the conditions under which communication with offenders takes place, matter for how we evaluate their treatment.

We have described the acute suffering generated by the contemporary life sentence, arguing that both its extreme length, and the centrality of risk to its paradigm of moral evaluation, compromise its communicative functions. Even retributivist theorists who do not value moral dialogue (but simply emphasise desert) might concede that excessive penal suffering could undermine the values they wish to vindicate -- moral agency, respect, responsibility. If retributive punishment means more than vengeance, and aims either to vindicate values or promote moral engagement, life sentences in England & Wales do not punish effectively.

Zaibert's [-@zaibertRethinkingPunishment2018, ch 4] critique of retributivism illuminates why this is so. He argues that 'pure' desert theories suffer from 'simple-mindedness' -- specifically, an impoverished theory of value.[^12] In reducing all values to desert, they evade the responsibilities punishers ought to feel. For Zaibert, this is 'impoverished' because it is inhospitable to what the poet Wilfred Owen called the 'eternal reciprocity of tears' -- the moral emotions that *should* trouble us.[^13] Such emotions -- 'remainders' [@zaibertRethinkingPunishment2018, ppp 145–6] -- can persist even after justified actions.[^14] To shut oneself off from them can be adaptive, but is also dehumanising (as Owen, reflecting on soldiers who numbed themselves to the effects of battlefield trauma, recognised). Zaibert's distinction between punishment and revenge hinges precisely on the punisher's capacity to perceive 'remainders' and experience moral conflict; while an avenger inflicts suffering 'simple-mindedly', the legitimate punisher does so while experiencing something like 'agent regret' -- a feeling not quite of moral guilt, but of more than generic sadness.[^15] Such 'remainders' carry moral implications for how to implement punishments, including in relation to the possibility of excess.

We elaborate Zaibert's point in two ways. First, prisoners' own accounts of punishment and suffering offer evidence of the moral conflict which Zaibert argues punishers ought to feel. Just as he insists that legitimate punishment must acknowledge 'remainders' of conflicting value, many LSPs -- including Tom and Frank, both quoted above -- demonstrate sophisticated moral reasoning. They neither wholly accept nor wholly reject institutional narratives about their culpability. They forgive themselves for some aspects while accepting profound responsibility for others -- recognising that quibbles over some elements of the official account pale against the grave losses their actions caused others. This nuanced moral engagement emerges through contingent, personal processes of reflection. We do not claim such epiphanies are universal. Crucially, though, we do not believe they are rare either, and our account of risk management suggests that it leaves little space for the pluralistic forms of responsibility which result. Such value pluralism, Zaibert suggests, is perhaps *the* hallmark of legitimate punishment.

Second, and more importantly, we suggest that the current implementation of the life sentence -- comprising an extremely long penalty phase, with progression organised around a monistic understanding of risk -- mirrors the 'simple-mindedness' Zaibert identifies in both 'pure' desert and 'pure' consequentialist theories of punishment. Moore [-@moorePlacingBlameTheory2010] argued that in sentencing, what the offender deserves trumps all other considerations: no further justification is required to punish, and no limiting principle applies other than proportionality. What we (following Williams) have termed an 'actuarial morality system' is similarly 'simple-minded', this time in applying consequentialist ethics. Its effect is to reduce almost all values to risk, and to defer recognition for prisoners' moral engagement until they have a) consumed a surfeit of retributive time, and b) learned to account for themselves in line with official expectations.

The sheer temporal burden of the contemporary life sentence leads to what we have called 'sedative coping'. When prisoners must anaesthetise themselves to survive -- becoming, in Mason's words, 'an emotionless person' -- they lose access to precisely those moral emotions which might deepen their engagement. A system that necessitates the suppression of feeling promotes passive endurance, and fails consistently to awaken or facilitate the moral engagement it purports to seek. Alternatively, some prisoners serving long sentences are calling out for such engagement, but find a response that does not align with their hopes in seeking it.

The obverse of this systemic disengagement is its selection of certain cases for intensive intervention based on assessed risk. By 'gripping' prisoners and their wrongdoing 'imperfectly' [see @creweTightnessRecognitionPenal2021, p 58], and unevenly, according to criteria many find mystifying [@jarmanMoralMessagesEthical2024, ch 6], and by failing to align with what we call windows of moral openness, prisons fail to engage seriously with their communicative duties. If anything, the acute anguish caused by very long sentences seems to impede such a goal, at least during the early stages of custody. At best, life sentences might produce space for prisoners to engage in moral reflection and some forms of accountability. But this is done clumsily, unevenly, and inconsistently, often with the responsibilities associated with avoiding future harms crowding out the responsibilities arising from past wrongs. Our suggestion is that prisons ought to support prisoners in synthesising both forms of responsibility, instead of monistically privileging one above the other.
...
[^2]: In this chapter, we use 'early', 'mid', and 'late' in a technical sense, to refer to the first, middle, and last thirds of the minimum term of imprisonment; 'post-tariff' refers to the time after its has expired.
[^3]: All names provided here are pseudonyms. We also include details of the age and sentence stage of quoted individuals, with the latter defined as per the preceding footnote.
[^4]: Only 13% of men in the very early stage of their tariff considered themselves to be guilty of murder [@creweLifeImprisonmentYoung2020].
[^5]: A third group comprised individuals convicted under Joint Enterprise, who felt -- not unwarrantedly -- that their convictions or sentences were illegitimate.
[^6]: In survey data, the mean severity scores for four out of these five items were considerably higher for men serving life sentences than for other prisoner sub-groups serving shorter sentences.
[^7]: A discontinued offending behaviour programme which facilitated face-to-face encounters between perpetrators and victims of violence.
[^8]: Published policies [eg @ministryofjusticeManageCustodialSentence2018; @ministryofjusticePrisonPublicProtection2024] specify a tiered approach to risk management but do not detail treatment allocation criteria. We understand that internal HMPPS guidance prioritises allocations based firstly on assessed risk and the imminence of actual or potential release and secondly on various factors including those we describe.
[^9]: An offending behaviour programme.
[^10]: A therapeutic prison.
...
[^13]: Wilfred Owen, 'Insensibility'; independently from Zaibert, one of us (BC) cited the same poem in an article which first elaborated the concept of 'sedative coping' which we expand here [@creweSedativeCopingContextual2024, pp. 1094–95].
[^14]: Zaibert's concept of 'remainders' originates in an essay by Williams [-@williamsPoliticsMoralCharacter1978] on the moral compromises inherent in public life, which identifies 'remainders" as the persistent moral discomfort or regret that can arise even from justified actions. Such feelings are often prompted by conflicts between rights and consequences, or by the tragic impossibility of reconciling contradictory moral values.
[^15]: Also coined by Williams [-@williamsMoralLuckPhilosophical1981] in his classic work on moral luck, 'agent regret' classifies the kind of regret a person might experience after causing harm without having done wrong. He offers the thought experiment of a lorry driver whose vehicle strikes a child who has darted into the road, and suggests that a driver who did not experience persistent feelings of regret might lack fully-developed moral sensibilities, even if to have prevented the collision would have been impossible. For Williams, such feelings are distinct from the regret one might experience on witnessing or learning about sad events at second or third-hand.
