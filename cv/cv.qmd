...
*Anniversary Fellow*&nbsp; &nbsp;
Postdoctoral research fellowship with two main objectives: converting my PhD research into a monograph and investigating parole decisions in England & Wales.

**Birkbeck University of London** \hfill Jul 2022-Nov 2024
...
## Briefings, reports and policy papers
...
<!-- Could add something here titling this impact and brining in some of the evidence back that I got while at Birkbeck and add subsequent things -->
...
**Qualitative** Research methods training: Qualitative Research in Practice (University of Cambridge). Experienced in sensitive research topics; semi-structured interviews; focus groups; qualitative analysis with NVivo/Atlas.ti; historical/archival research; team research; research data management; AI transcription using open-source models.
...
**Publishing** Document publication systems (WordPress, Markdown, Typora, VSCode, Pandoc, Quarto, GitHub Pages, Typst); packages and platforms relating to Open Access publishing and version control (PubPub, Symplectic Elements, Git).
